...
urlpatterns = [
    path('pharmacy-create/', PharmacyAPIView.as_view(), name='pharmacy-list-create'),
    path('pharmacy/<int:pk>/', PharmacyDetail.as_view(), name='pharmacy-detail'),
    path('pharmacy-products/', PharmacyProductListCreateView.as_view(), name='pharmacy-product-list-create'),
    path('pharmacy-products/<int:pk>/', PharmacyProductDetailView.as_view(), name='pharmacy-product-detail'),
    path('pharmacy/<int:pharmacy_id>/products/', 
         PharmacyProductsByPharmacyView.as_view(), 
         name='pharmacy-products-list'),
